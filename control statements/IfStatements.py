...
#wap to print fizz if num is divisible of 3 print buzz if num is divisible of 5 print fizzbuzz if it is divisible by both 3&5
num=int(input('enter the number :'))
...
# check the points are lying on which quadrant
...
#wap a program to convert A to a and a to b and 1...10 to '1'...'10' and asqll value for special char:
